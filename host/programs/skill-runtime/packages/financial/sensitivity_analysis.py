...
class SensitivityAnalyzer:
    ...
    def one_way_sensitivity(
        ...
        test_values = _linspace(min_val, max_val, steps)
    ...
    def two_way_sensitivity(
        ...
        """
        results = [[0.0 for _ in var2_range] for _ in var1_range]
    ...
    def tornado_analysis(
        self, variables: dict[str, dict], output_func: Callable
    ) -> pd.DataFrame:
        """
    ...
    def scenario_analysis(
        ...
        output_func: Callable,
        probability_weights: dict | None = None,
    ) -> pd.DataFrame:
        """
...
def create_data_table(
    row_variable: tuple[str, list, Callable],
    col_variable: tuple[str, list, Callable],
    output_func: Callable,
) -> pd.DataFrame:
    """
    ...
    results = [[0.0 for _ in col_values] for _ in row_values]
