/**
 * ARCHIVED — not a product HTTP server. Do not run. Do not npm-start.
 *
 * This file used to listen on EMPIRE_PORT (default 7377) as a second
 * gateway using lib/gateway. The live control plane is:
 *   npm start  →  serve.js  →  127.0.0.1:18793 (L7_PORT)
 *
 * Empire UI assets remain at empire/public/ as a frozen client, not a listener.
 * Relative requires here are not the start path.
 */
