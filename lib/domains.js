...
function transition(fromDomain, toDomain, name, options = {}) {
  ...
  // Copy then unlink — file move, not a morphic law.
...
/**
 * 12D does not grant domain (ADR 0001); caller must pass an explicit domain.
 * Always returns null. The coordinate argument is ignored.
 */
