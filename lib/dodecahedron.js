...
const DIMENSIONS = Object.freeze([
  // Modern astronomy: orbital periods in Earth days, semi-major axis in AU
  // Classical ring: the 7 traditional bodies visible to the naked eye
  { index: 0,  planet: 'Sun',        symbol: '☉', name: 'capability',     ring: 'classical',      question: 'What does it do?',                  orbital_days: 0,        au: 0,       metal: 'gold',        mass_kg: 1.989e30 },
  { index: 1,  planet: 'Moon',       symbol: '☽', name: 'data',           ring: 'classical',      question: 'What kind of information?',          orbital_days: 27.32,    au: 0.00257, metal: 'silver',      mass_kg: 7.342e22 },
  { index: 2,  planet: 'Mercury',    symbol: '☿', name: 'presentation',   ring: 'classical',      question: 'How does it appear?',                orbital_days: 87.97,    au: 0.387,   metal: 'quicksilver', mass_kg: 3.301e23 },
  { index: 3,  planet: 'Venus',      symbol: '♀', name: 'persistence',    ring: 'classical',      question: 'How long does it live?',             orbital_days: 224.7,    au: 0.723,   metal: 'copper',      mass_kg: 4.867e24 },
  { index: 4,  planet: 'Mars',       symbol: '♂', name: 'security',       ring: 'classical',      question: 'Who can access it?',                 orbital_days: 687.0,    au: 1.524,   metal: 'iron',        mass_kg: 6.417e23 },
  { index: 5,  planet: 'Jupiter',    symbol: '♃', name: 'detail',         ring: 'classical',      question: 'How granular?',                      orbital_days: 4332.59,  au: 5.203,   metal: 'tin',         mass_kg: 1.898e27 },
  { index: 6,  planet: 'Saturn',     symbol: '♄', name: 'output',         ring: 'classical',      question: 'What form are results?',             orbital_days: 10759.22, au: 9.537,   metal: 'lead',        mass_kg: 5.683e26 },
  // Transpersonal ring: discovered by telescope, beyond naked-eye perception
  { index: 7,  planet: 'Uranus',     symbol: '♅', name: 'intention',      ring: 'transpersonal',  question: 'What is the will behind it?',        orbital_days: 30688.5,  au: 19.19,   metal: 'platinum',    mass_kg: 8.681e25 },
  { index: 8,  planet: 'Neptune',    symbol: '♆', name: 'consciousness',  ring: 'transpersonal',  question: 'How aware is it?',                   orbital_days: 60182.0,  au: 30.07,   metal: 'neptunium',   mass_kg: 1.024e26 },
  { index: 9,  planet: 'Pluto',      symbol: '♇', name: 'transformation', ring: 'transpersonal',  question: 'How deeply does it change things?',  orbital_days: 90560.0,  au: 39.48,   metal: 'plutonium',   mass_kg: 1.303e22 },
  // Nodal axis: the intersection of lunar orbit and ecliptic — precesses every 18.6 years
  { index: 10, planet: 'North Node', symbol: '☊', name: 'direction',      ring: 'transpersonal',  question: 'Where is it heading?',               orbital_days: 6793.5,   au: null,    metal: null,          mass_kg: null },
  { index: 11, planet: 'South Node', symbol: '☋', name: 'memory',         ring: 'transpersonal',  question: 'Where did it come from?',            orbital_days: 6793.5,   au: null,    metal: null,          mass_kg: null }
]);

// Zodiacal qualities — the 12 behavioral archetypes (one per face)
// Rulers follow traditional domicile. Exaltations follow Ptolemaic tradition.
// This is the actual sky — each sign governed by its ruling planet.
const ZODIAC = Object.freeze([
  { sign: 'Aries',       symbol: '♈', quality: 'initiative',   element: 'fire',  mode: 'cardinal', ruler: 'Mars',    rulerIndex: 4,  exaltation: 'Sun' },
  { sign: 'Taurus',      symbol: '♉', quality: 'substance',    element: 'earth', mode: 'fixed',    ruler: 'Venus',   rulerIndex: 3,  exaltation: 'Moon' },
  { sign: 'Gemini',      symbol: '♊', quality: 'duality',      element: 'air',   mode: 'mutable',  ruler: 'Mercury', rulerIndex: 2,  exaltation: null },
  { sign: 'Cancer',      symbol: '♋', quality: 'containment',  element: 'water', mode: 'cardinal', ruler: 'Moon',    rulerIndex: 1,  exaltation: 'Jupiter' },
  { sign: 'Leo',         symbol: '♌', quality: 'expression',   element: 'fire',  mode: 'fixed',    ruler: 'Sun',     rulerIndex: 0,  exaltation: null },
  { sign: 'Virgo',       symbol: '♍', quality: 'analysis',     element: 'earth', mode: 'mutable',  ruler: 'Mercury', rulerIndex: 2,  exaltation: 'Mercury' },
  { sign: 'Libra',       symbol: '♎', quality: 'balance',      element: 'air',   mode: 'cardinal', ruler: 'Venus',   rulerIndex: 3,  exaltation: 'Saturn' },
  { sign: 'Scorpio',     symbol: '♏', quality: 'depth',        element: 'water', mode: 'fixed',    ruler: 'Pluto',   rulerIndex: 9,  exaltation: null },
  { sign: 'Sagittarius', symbol: '♐', quality: 'expansion',    element: 'fire',  mode: 'mutable',  ruler: 'Jupiter', rulerIndex: 5,  exaltation: null },
  { sign: 'Capricorn',   symbol: '♑', quality: 'structure',    element: 'earth', mode: 'cardinal', ruler: 'Saturn',  rulerIndex: 6,  exaltation: 'Mars' },
  { sign: 'Aquarius',    symbol: '♒', quality: 'innovation',   element: 'air',   mode: 'fixed',    ruler: 'Uranus',  rulerIndex: 7,  exaltation: null },
  { sign: 'Pisces',      symbol: '♓', quality: 'dissolution',  element: 'water', mode: 'mutable',  ruler: 'Neptune', rulerIndex: 8,  exaltation: 'Venus' }
]);

// Planetary days — the Chaldean wheel governs each day of the week.
// This is the actual sky: each planet rules the first hour of its day.
const PLANETARY_DAYS = Object.freeze({
  0: { day: 'Sunday',    planet: 'Sun',     index: 0,  metal: 'gold',        symbol: '☉' },
  1: { day: 'Monday',    planet: 'Moon',    index: 1,  metal: 'silver',      symbol: '☽' },
  2: { day: 'Tuesday',   planet: 'Mars',    index: 4,  metal: 'iron',        symbol: '♂' },
  3: { day: 'Wednesday', planet: 'Mercury', index: 2,  metal: 'quicksilver', symbol: '☿' },
  4: { day: 'Thursday',  planet: 'Jupiter', index: 5,  metal: 'tin',         symbol: '♃' },
  5: { day: 'Friday',    planet: 'Venus',   index: 3,  metal: 'copper',      symbol: '♀' },
  6: { day: 'Saturday',  planet: 'Saturn',  index: 6,  metal: 'lead',        symbol: '♄' }
});

// Chaldean order — planets by apparent speed (slowest to fastest).
// Governs planetary hours. The first hour of each day = that day's planet.
const CHALDEAN_ORDER = Object.freeze([
  { planet: 'Saturn',  index: 6 },
  { planet: 'Jupiter', index: 5 },
  { planet: 'Mars',    index: 4 },
  { planet: 'Sun',     index: 0 },
  { planet: 'Venus',   index: 3 },
  { planet: 'Mercury', index: 2 },
  { planet: 'Moon',    index: 1 }
]);
...
/**
 * Derive an internal 12D coordinate from a tool definition (.tool file).
 * Maps declared YAML fields to field weights. This is an internal_projection
 * (ADR 0001). It does not grant identity or domain and is not the public 7D
 * contract — that lives in tool.l7 / GET /v1/tools.
 */
...
// File: lib/dodecahedron.js | Body-Hash: SHA-256:56d9f9b9c4fbfd5134b99a960f2035f0608b175b781c31b53cac7559bc61e43d
// Chain-Hash: SHA-256:4312477733a9749917452f3b205646d9131e1d30ad45df9950964d13be7e496a | Signed: 2026-03-01T15:09:50.015855+00:00
// This work is the intellectual property of Alberto Valido Delgado.
// Chain: 16 works. Verify: python3 provenance.py verify lib/dodecahedron.js
// L7:PROVENANCE