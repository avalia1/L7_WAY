...
function heartbeat() {
  ...
  const nodes = Array.from(field.nodes.values());
  if (nodes.length < 2) return { beat: vascular.totalBeats, skipped: 'insufficient_nodes', phases: {} };
...
function startPulse(options = {}) {
  ...
  function beat() {
    ...
    if (options.onFire && report.phases && report.phases.firing && report.phases.firing.nodes_fired > 0) {
      options.onFire(report.phases.firing);
    }
    if (options.onCoherence && report.phases && report.phases.coherence) {
...
// File: lib/field.js | Body-Hash: SHA-256:ae037223a08a329799813e70b3f2e651d024864b5f2b3fe676f925df936466cf
// Chain-Hash: SHA-256:3e7595aed6b3bb6e0cb4dc84edb997e87886ad5e915d4b5ce48478d27132b090 | Signed: 2026-03-01T15:09:50.017401+00:00
// This work is the intellectual property of Alberto Valido Delgado.
// Chain: 19 works. Verify: python3 provenance.py verify lib/field.js
// L7:PROVENANCE